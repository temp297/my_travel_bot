...
async def generate_and_send_travel_news():
    ...
    prompt = (
        ...
        f"{today_focus}\n\n"
        f"⛔ КАТЕГОРИЧНА ЗАБОРОНЕНО СМИТСЛОВІ ПОВТОРИ ТА СТАРІ ФАКТИ:\n"
        ...
        f"- Категорично ЗАБОРОНЕНО вигадувати новини, факти, дати, авіарейси чи стан кордонів. Усі події мають бути реальними фактами із новинних джерел.\n\n"
