...
async def generate_and_send_ai_tour_post():
    ...
    # ==========================================
    # НАЛАШТУВАННЯ ТЕМИ (TOPIC ID)
    # Змініть число 198 на реальний ID вашої теми "Навігатор дня"
    # ==========================================
    ...
    categories = [
        {"name": "Туреччина", "prompt_part": "Знайди та вибери РІВНО 5 різних найкращих готелів 4★ та 5★ СУТО в ТУРЕЧЧИНІ."},
        {"name": "Єгипет", "prompt_part": "Знайди та вибери РІВНО 5 різних найкращих готелів 4★ та 5★ СУТО в ЄГИПТІ."},
        {"name": "Україна", "prompt_part": "Знайди та вибери РІВНО 5 різних найкращих пропозицій або готелів СУТО в УКРАЇНІ."},
        {"name": "Інші Країни", "prompt_part": "Знайди та вибери РІВНО 5 різних найкращих готелів 4★ та 5★ з БУДЬ-ЯКИХ ІНШИХ КРАЇН, окрім Туреччини, Єгипту та України."}
    ]
    ...
    for cat in categories:
        prompt = (
            f"Ти — професійний trevel-копірайтер. На основі наступного тексту з туристичними даними склади один цікавий, "
            ...
            f"2. Першим рядком поста ОБОВ'ЯЗКОВО має бути виключно заголовок: ☀️ <b>ТОП пропозицій: {cat['name']}</b>\n"
            f"3. ХУДОЖНІЙ ВСТУП (ОБОВ'ЯЗКОВО): Одразу після заголовка напиши один короткий, емоційний та вступний художній абзац (на 2-4 речення), який яскраво описує переваги відпочинку в цій країні/напрямку, щоб зацікавити читача.\n"
            ...
            f"5. ОБМЕЖЕННЯ: Описуй кожен готель ємно. Твій підсумковий текст має бути коротшим за 3400 символів. Використовуй тільки HTML-теги <b> та <i>.\n\n"
        ...
        try:
            ...
            # НАДКАЗАНО НАДСИЛАТИ СТРОГО В КУНКРЕТНИЙ ТОПІК (message_thread_id)
