...
# Базовий шаблон для всіх фото з Unsplash (щоб не дублювати його в коді 75 разів)
    ...
    for index, cat in enumerate(categories):
        ...
        prompt = (
            ...
            f"⛔ СУВОРЕ ПРАВИЛО ФАКТИЧНОЇ НАЯВНОСТІ ТРАНСПОРТУ (ЗАБОРОНА ФАНТОМНИХ РЕЙСІВ):\n"
            f"1. Ти зобов'язаний зчитувати тип транспорту СУВОРО з наданого тексту. Заборонено вигадувати авіапереліт чи автобус, якщо їх немає в джерелі для конкретного готелю!\n"
            f"2. Якщо в тексті для готелю вказано 'Без транспорту', 'Власний транспорт', 'Тільки проживання', 'Без трансферу', або взагалі ВІДСУТНЯ згадка про авіа чи автобус — тобі КАТЕГОРИЧНО ЗАБОРОНЕНО писати '✈️ Авіа' чи '🚌 Автобус'.\n"
            f"3. У такому разі в полі трансферу ти зобов'язаний ЧЕСНО вказати: '🚗 Власний транспорт / без трансферу'.\n"
            f"4. Пріоритет авіатурів працює ТІЛЬКИ для тих варіантів, де авіапереліт ДІЙСНО прописаний у наданих даних. Якщо всі готелі в джерелі без транспорту — виводь їх як '🚗 Власний транспорт', а не роби з них фейкові авіатури!\n\n"
        
            f"🚫 ПРАВИЛО ЛОГІКИ ТРАНСПОРТУ ТА ЕМОДЗІ (ЗАБОРОНА ПЛУТАНИНИ):\n"
            f"1. Автобусні тури маркуються ЛИШЕ символом 🚌 в усьому рядку. Наприклад: '🚌 <b>Трансфер та виїзд:</b> Автобус із Києва' або '🚌 <b>Трансфер та виїзд:</b> Автобус зі Львова'. Заборонено в цей рядок ставити літак ✈️!\n"
            f"2. Авіатури маркуються ЛИШЕ символом ✈️ в усьому рядку. Наприклад: '✈️ <b>Трансфер та виїзд:</b> Авіа з Кишинева' або '✈️ <b>Трансфер та виїзд:</b> Авіа з Варшави'. Заборонено в цей рядок ставити автобус 🚌!\n"
            f"3. Тури без транспорту/на власному авто маркуються ЛИШЕ символом 🚗. Наприклад: '🚗 <b>Трансфер та виїзд:</b> Власний транспорт / без трансферу'.\n"
            f"4. Ніколи не зліплюй емодзі автобуса з текстом про авіарейси чи власний транспорт. Кожен тип транспорту має відповідати своєму єдиному значку.\n"
            f"5. ЗАБОРОНА ФЕЙКОВИХ ВИЛЬОТІВ З УКРАЇНИ: Наразі авіатури з міст України (Київ, Харків, Львів, Одеса тощо) не здійснюються! Якщо тур дійсно авіаційний — місто вильоту обов'язково має бути іноземним (Кишинів, Варшава, Жешув, Сучава, Катовіце тощо). З українських міст можливий ТІЛЬКИ автобусний виїзд чи власний транспорт. Не вигадуй вильоти літаків з України!\n\n"
            ...
            f"- У полі трансферу та виїзду ОБОВ'ЯЗКОВО має бути чітко вказано конкретне місто вильоту чи виїзду (якщо транспорт є), або чітко 'Власний транспорт / без трансферу'. Жодних розмитих формулювань.\n"
            ...
            f"⚠️ ГОЛОВНИЙ КРИТЕРІЙ ВІДБОРУ — ПРІОРИТЕТ ТРАНСПОРТУ ТА ПОВНОГО ПАКЕТУ:\n"
            f"Проаналізуй ФАКТИЧНО НАЯВНИЙ тип транспорту в джерелі та відбирай варіанти за суворим каскадом:\n"
            f"1. ПРІОРИТЕТ №1 — ДІЙСНІ АВІАТУРИ: Шукай у тексті готелі, де ЯВНО вказано авіапереліт (літак/авіа з Кишинева, Сучави, Жешува, Варшави тощо).\n"
            f"   🔥 КРИТИЧНА ВИМОГА ДЛЯ АВІА: Серед усіх знайдених авіатурів ти зобов'язаний ПЕРШОЧЕРГОВО вибирати варіанти, які є ПОВНИМ ПАКЕТОМ (куди одночасно включено Проїзд, Страховка та Трансфер до готелю). Якщо дійсних авіатурів у тексті є хоча б 3-5 штук, повністю ігноруй автобуси та власний транспорт!\n"
            f"2. ПРІОРИТЕТ №2 — ДІЙСНІ АВТОБУСНІ ТУРИ: Включай автобусні тури у пост ТІЛЬКИ у випадку, якщо в наданих даних взагалі немає жодного реального авіатуру по цій країні.\n"
            ...
            f"3. ПРІОРИТЕТ №3 — ВЛАСНИЙ ТРАНСПОРТ / БЕЗ ТРАНСФЕРУ: Варіанти 'Власний транспорт / Без трансферу' дозволено брати лише в крайньому разі, якщо в наданих даних немає ні реальних авіа, ні автобусів.\n"
            f"Підсумок: Ніколи не додавай вигаданий авіапереліт до туру, де написано 'без транспорту'!\n\n"
        
            f"⚠️ КРИТИЧНО ВАЖЛИВЕ ПРАВИЛО ДЛЯ НАЙНИЖЧОЇ ЦІНИ ТА СИНХРОНІЗАЦІЇ:\n"
            f"- Коли алгоритм відібрав готелі за фактично наявним транспортом, вибирай серед них варіанти за ЯКІСТЮ та НАЙВИГІДНІШОЮ ціною для конкретної кількості ночей.\n"
            ...
            f"1. Знайди в тексті конкретного туру дату вильоту/виїзду/заїзду (день, місяць, рік), яка прописана поруч із обраною ціною. За забороною вигадувати дані самостійно.\n"
            ...
            f"5. Після художнього вступу виведи список готелів. Для КОЖНОГО готелю суворо використовуй наступний візуальний шаблон (заповнюй дані, зберігаючи відповідний транспорту емодзі та жирний шрифт, у полі виїзду обов'язково вказуй назву міста або факт відсутності проїзду):\n\n"
        
            f"📍 <b>{cat['name'].upper()} ([Вкажи регіон/курорт])</b>\n"
            f"🏨 <b>[Назва готелю латиницею в оригіналі] [Зірковість, наприклад 4⭐ або 5⭐]</b>\n"
            f"[Обери ТІЛЬКИ ОДИН РЯДОК залежно від фактичного транспорту в джерелі]:\n"
            f"• Якщо авіа: ✈️ <b>Трансфер та виїзд:</b> Авіа з [Закордонне місто, напр. Кишинева]\n"
            f"• Якщо автобус: 🚌 <b>Трансфер та виїзд:</b> Автобус із [Місто, напр. Києва]\n"
            f"• Якщо без транспорту: 🚗 <b>Трансфер та виїзд:</b> Власний транспорт / без трансферу\n"
            ...
            f"- СУВОРЕ ПРАВИЛО ДЛЯ ДАТИ: За заборонено примусово міняти формат дати. Відображай символ в символ, як у тексті джерела. Без самодіяльності та зайвих знаків.\n"
