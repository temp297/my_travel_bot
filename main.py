...
async def generate_and_send_travel_news():
    ...
    prompt = (
        ...
        f"2. <b>Привітання та вступ (1-2 речення):</b> Почни пост з короткого дружнього привітання мандрівників із зазначенням дня тижня та дати (наприклад: 'Привіт, мандрівники! Сьогодні {today_weekday}, {current_date_str}...').\n\n"
        ...
        f"4. <b>Важливо для українців / Правила в'їзду:</b> (НЕ використовуй слово 'Фокус'! Вживай фрази 'Важливо для мандрівників' або 'Правила в'їзду') — чітко зазнач умови саме для біометричного паспорта (наприклад: 'безвіз 90 днів', 'EES автоматичний контроль', 'eVisa').\n\n"
        f"5. <b>Лайфхак / Практична порада дня:</b> 1-2 речення короткої поради (наприклад, онлайн-камери ДПСУ, часи найменшого завантаження КПП, транзитні нюанси тощо).\n\n"
