...
async def generate_and_send_travel_news():
    ...
    prompt = (
        ...
        f"⛔ 100% ЗАБОРОНА НА ВИГАДУВАННЯ ТА ГАЛЮЦИНАЦІЇ:\n"
        ...
        f"- Якщо ти не маєш підтвердженої реальної новини за якийсь конкретний напрямок, НЕ вигадуй її — візьми іншу РЕАЛЬНУ подію із галузі міжнародних подорожей чи авіації.\n\n"
