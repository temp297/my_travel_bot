...
async def generate_and_send_travel_news():
    ...
    prompt = (
        ...
        f"- Обирай події з різних куточків світу: наприклад, 1 новина — Азія/Екзотика, 1 новина — Європа/Кордон, 1 новина — авіація/транзит або нові візові правила.\n"
        f"- Чергуй теми: візові оновлення, нові авіарейси з сусідніх країн (Польща, Молдова, Румунія), зміни в туристичних зборах, правила перебування, цікаві сезонні події.\n\n"
        ...
        f"- Мова: українська.\n"
        f"- Обсяг: до 2500 символів (текст має легко читатися з мобільного).\n"
