...
async def generate_and_send_travel_news():
    ...
    prompt = (
        f"Ти — незалежний журналіст та експерт із міжнародного туризму.\n\n"
        f"Сьогодні {current_date_str}. Напиши свіжий, унікальний та інформативний дайджест світових туристичних новин "
        f"для українських мандрівників, які планують подорож до будь-якої країни світу.\n\n"
        ...
        f"- Обирай події з різних куточків світу: наприклад, 1 новина — Азія/Екзотика, 1 новина — Європа, 1 новина — Кордон, 1 новина — авіація/транзит або нові візові правила.\n"
        ...
        f"🌎 СТРУКТУРА ПОСТА:\n\n"
        f"1. <b>Заголовок:</b> лаконічний, що відображає головну новину дня, з тематичними емодзі (🌍, ✈️, 🛂, 🏝️).\n\n"
        f"2. <b>Дайджест новин (2–3 пункти):</b>\n"
        f"   - Кожна новина має короткий підзаголовок та 2-3 речення суті.\n"
        f"   - Для новин про візи чи кордони чітко зазначай умови саме для громадян України з біометричним паспортом.\n\n"
        f"3. <b>Корисний лайфхак дня:</b> 1-2 речення практичної поради для мандрівників (наприклад, корисний сервіс, зекономлений транзит, страхування чи валютні нюанси).\n\n"
        f"4. <b>Хештеги:</b> 3–5 релевантних хештегів (#подорожі #новинитуризму #кордон #безвіз #авіа).\n\n"
        f"⚠️ СУВОРІ ВИМОГИ ДО ФОРМАТУВАННЯ ТА СТИЛЮ:\n"
        f"- Мова: українська.\n"
        f"- Стиль: діловий, лаконічний, журналістський, без «води».\n"
        f"- Форматування: ТІЛЬКИ HTML-теги Telegram (<b>, <i>, <code>, <a href=\"...\">).\n"
        f"- Категорично заборонено використовувати Markdown (без **, ##, __, *)."
    )
