...
async def generate_and_send_ai_tour_post():
    ...
    categories = [
        ...
        {"name": "УКРАЇНА", "flag": "🇺🇦", "stars": "4★ та 5★", "prompt_part": "Уважно проскануй весь текст джерела від початку до кінця і витягни до 5 РІЗНИХ найкращих пропозицій або готелів СУТО в УКРАЇНІ. Постарайся знайти кілька варіантів списком!"},
        {"name": "ІНШІ КРАЇНИ", "flag": "🌍", "stars": "4★ та 5★", "prompt_part": "Уважно проскануй весь текст джерела від початку до кінця і витягни до 5 РІЗНИХ найкращих готелів з БУДЬ-ЯКИХ ІНШИХ КРАЇН, окрім Туреччини, Єгипту та України."}
    ]
