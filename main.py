...
prompt = (
        ...
        f"🎯 ДОДАТКОВИЙ ДИНАМІЧНИЙ НАПРЯМОК ДНЯ (ДЛЯ 2-3 ПУНКТІВ НОВИН):\n"
        f"{today_focus}\n\n"
        ...
        f"2. <b>Дайджест світових новин (2–4 пункти):</b>\n"
        ...
        f"   - <b>Пункти 2–3: Світові новини та регіональний напрямок:</b> свіжі новини туризму, авіації, віз та відпочинку відповідно до додаткового напрямку дня.\n\n"
        f"3. <b>Важливо для українців / Правила в'їзду:</b> (НЕ використовуй слово 'Фокус'! Вживай фрази 'Важливо для мандрівників' або 'Правила в'їзду') — чітко зазнач умови саме для біометричного паспорта (наприклад: 'безвіз 90 днів', 'EES автоматичний контроль', 'eVisa').\n\n"
        f"4. <b>Лайфхак / Практична порада дня:</b> 1-2 речення короткої поради (наприклад, онлайн-камери ДПСУ, часи найменшого завантаження КПП, транзитні нюанси тощо).\n\n"
        f"5. <b>Хештеги:</b> 3–5 тематичних хештегів (#подорожісвітом #новинитуризму #кордон #безвіз #подорожі2026).\n\n"
    ...
    try:
        ...
        header_text = f"📰 <b>Дайджест туристичних новин та кордонів | {current_date_str}</b>\n\n"
