...
async def generate_and_send_travel_news():
    ...
    prompt = (
        ...
        f"- <b>ОБОВ'ЯЗКОВІ ВІДСТУПИ:</b> Відокремлюй КОЖЕН номер новини (1, 2, 3...), розділи поста та блок хештегів ПОРОЖНІМ РЯДКОМ. Текст ні в якому разі не повинен зливатися в один монолітний абзац!\n"
        f"- Мова: українська.\n"
