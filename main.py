...
async def generate_and_send_travel_news():
    ...
    # --- 4. ГЕНЕРАЦІЯ ПРОМПТА З ЖОРСТКИМ ФІЛЬТРОМ ПОВТОРІВ КОРДОНУ ---
    ...
    prompt = (
        ...
        f"🎯 ДОДАТКОВИЙ ДИНАМІЧНИЙ ФОКУС ДНЯ (ДЛЯ 2-3 ПУНКТІВ НОВИН):\n"
        f"{today_focus}\n\n"
        f"⛔ КАТЕГОРИЧНА ЗАБОРОНА НА СМИСЛОВІ ПОВТОРИ ТА СТАРІ ФАКТИ:\n"
        ...
        f"🚫 КАТЕГОРИЧНА ЗАБОРОНА НА САМОРЕКЛАМУ:\n"
        ...
        f"   - <b>Пункти 2–3: Світові новини та регіональний фокус:</b> свіжі новини туризму, авіації, віз та відпочинку відповідно до додаткового фокусу дня.\n\n"
        f"3. <b>Фокус для українського мандрівника:</b> умови біометрики чи документів (наприклад: 'безвіз 90 днів', 'EES автоматичний контроль', 'eVisa').\n\n"
