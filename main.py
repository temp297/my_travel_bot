...
async def generate_and_send_ai_tour_post():
    ...
    f" Після художнього вступу виведи список готелів. Для КОЖНОГО готелю суворо використовуй наступний візуальний шаблон (заповнюй дані, зберігаючи емодзі та жирний шрифт):\n\n"
    
    f"📍 <b>{cat['name'].upper()} ([Вкажи регіон/курорт])</b>\n"
    f"🏨 <b>[Назва готелю латиницею в оригіналі] [Зірковість, наприклад: 4* або 5*]</b>\n"
    f"🚌 <b>Трансфер та виїзд:</b> [Приклади: '✈️ Авіа з Варшави', '✈️ Авіа з Кишинева', '🚌 Автобус із Києва', '🚗 Власний транспорт / Без трансферу']\n"
    f"🍽 <b>Харчування:</b> [Вкажи тип харчування, що відповідає обраній ціні, наприклад: 'Все включено (AI)' або 'Без харчування (RO)']\n"
    f"📅 <b>Виліт/Дата:</b> [Вкажи дату у форматі ДД.ММ.РРРР та кількість ночей, що відповідають ціні]\n"
