...
async def generate_and_send_ai_tour_post():
    ...
    for index, cat in enumerate(categories):
        ...
        prompt = (
            ...
            f"⚠️ КРИТИЧНО ВАЖЛИВЕ ПРАВИЛО ФІЛЬТРАЦІЇ ЦІНА / ЯКІСТЬ:\n"  # <-- НОВИЙ БЛОК ПРАВИЛ
            f"Ти повинен виступати як розумний турагент. НІКОЛИ не вибирай готелі з невиправдано високими, космічними цінами (якщо в тексті є варіанти за 50-70 тис. грн, не виводь варіанти за 150-250 тис. грн, хіба що альтернатив взагалі немає). "
            f"Твоя мета — знайти 'золоту середину'. Обирай готелі, які мають хороший опис, реальні матеріальні плюси (аквапарк, перша лінія, хороший сервіс), але при цьому коштують ДОСТУПНО та КОНКУРЕНТНО. Добірка має бути привабливою для середнього клієнта, який шукає вигідну ціну за якісний відпочинок. Роби ставку на гарячі пропозиції та найкраще співвідношення ціни та сервісу!\n\n"
