...
async def generate_and_send_ai_tour_post():
    ...
    for index, cat in enumerate(categories):
        ...
        prompt = (
            ...
            f"➖ <b>Мінуси:</b> [Коротко вкажи нюанси або мінуси самого готелю: старий номерний фонд, платні парасольки тощо. КРИТИЧНО: Якщо в тексті немає явних мінусів, напиши нейтральний художній нюанс, але НІКОЛИ не пиши технічні виправдання!]\n\n"
            ...
            f"6. ОБМЕЖЕННЯ: Описуй кожен готель ємно. Твій підсумковий текст має бути не більше за 3000 символів. Використовуй тільки HTML-теги <b> та <i>.\n\n"
