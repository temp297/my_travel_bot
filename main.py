                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        if "грн" in page_text or "ноч" in page_text:
                            # КРИТИЧНО: Ізолюємо дані країни у виражені теги, щоб ШІ не змішував їх з іншими
...
async def generate_and_send_ai_tour_post():
    ...
    for index, cat in enumerate(categories):
        ...
        prompt = (
            ...
            f"2. Якщо готелів 5★ в тексті немає або їх замало, только тоді додавай/переходь до вибору готелів зірковості 4★ (4*).\n"
