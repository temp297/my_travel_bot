...
async def generate_and_send_travel_news():
    ...
    prompt = (
        ...
        f"- Використовуй інформацію з БУДЬ-ЯКИХ надійних, авторитетних світових та українських туристичних ЗМІ, авіаційних порталів та офіційних джерел (наприклад, Lowcost.ua, Avianews, Euronews Travel, Simple Flying, Skift, МЗС України, офіційні сайти авіакомпаній та візових центрів тощо).\n"
        ...
        f"- Категорично ЗАБОРОНЕНО вигадувати новини, факти, дати, авіарейси чи візові зміни. Усі події мають бути реальними фактами із новинних джерел.\n"
        f"- Якщо ти не маєш підтвердженої реальної новини за якийсь конкретний напрямок, НЕ вигадуй її — сформуй дайджест на основі ДІЮЧИХ РЕАЛЬНИХ ПРАВИЛ ПЕРЕТИНУ КОРДОНУ (умови безвізу з біометричним паспортом, система EES/ETIAS у Європі, правила оформлення eVisa в Азію/ОАЕ, сезонні вимоги тощо).\n\n"
        f"🚫 КАТЕГОРИЧНА ЗАБОРОНА НА САМОРЕКЛАМУ:\n"
        f"- Заборонено згадувати електронних помічників, ботів, закликати звертатися до компанії, писати про консультації чи бронювання.\n"
        f"- Пост повинен бути чисто інформаційним ЗМІ-дайджестом без рекламного «сміття» та самопрезентацій.\n\n"
        f"🎯 ГОЛОВНА МЕТА:\n"
        ...
        f"🎲 РІЗНОМАНІТНІСТЬ ТА УНІКАЛЬНІСТЬ НОВИН (УНИКАЙ ПОВТОРІВ):\n"
        f"- Сформуй дайджест із 2–4 СВІЖИХ та РІЗНОПЛАНОВИХ новин. Не фокусуйся щодня на одній і тій самій країні чи темі.\n"
        f"- Обирай події з різних куточків світу: наприклад, 1 новина — Азія/Екзотика, 1 новина — Балкани/Середземномор'я, 1 новина — Європа, 1 новина — Логістика/Кордон (Україна, Молдова, сусідні країни ЄС), 1 новина — авіація/транзит та візові оновлення.\n"
        f"- Чергуй теми: візові оновлення, нові авіарейси чи автобусні маршрути з сусідніх країн (Польща, Молдова, Румунія), зміни в туристичних зборах, правила перебування, цікаві сезонні події.\n\n"
        ...
        f"   - <b>Балкани та Середземномор'я (Туреччина, Болгарія, Чорногорія, Греція тощо):</b> сезонні правила в'їзду, транзитні нюанси, нові автобусні та авіамаршрути, правила перебування та туристичні збори.\n"
        f"   - <b>Азія та Близький Схід (ОАЕ, Балі/Індонезія, Таїланд, Шрі-Ланка тощо):</b> запуски нових візових правил, спрощення в'їзду (eVisa, безвізи), сезонні тренди або відкриття нових локацій/готелів.\n"
        f"   - <b>Америка та Кариби (США, Домінікана, Мексика тощо):</b> важливі візові оновлення, нові авіарейси з сусідніх до України аеропортів (Варшава, Кишинів, Бухарест, Будапешт).\n"
        f"   - <b>Африка та екзотика (Єгипет, Танзанія/Занзібар, Мальдіви, Сейшели тощо):</b> правила туристичних зборів, зміни у відвідуванні заповідників або визначних пам'яток.\n"
        ...
        f"   Якщо новина стосується віз чи документів — чітко вкажи умови саме для власників українського біометричного паспорта (наприклад: 'безвіз до 90 днів', 'оформлення eVisa за $50', 'безкоштовний штамп по прибуттю').\n\n"
        f"4. <b>Лайфхак / Практична порада дня:</b> 1-2 речення короткої поради (наприклад, корисний сервіс, зекономлений транзит, страхування чи валютні нюанси тощо).\n\n"
        f"5. <b>Хештеги:</b> 3–5 тематичних хештегів (наприклад: #подорожісвітом #новинитуризму #безвіз #подорожі2026 #екзотика).\n\n"
    ...
    try:
        ...
        # --- 3. НАДСИЛАННЯ ПОВІДОМЛЕННЯ В ТЕЛЕГРАМ ---
