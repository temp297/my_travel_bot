...
try:
    ...
    ASSISTANT_MINUTE = int(os.getenv("ASSISTANT_MINUTE", "38"))
except ValueError:
...
current_year = datetime.now().strftime("%Y")  # Автоматично отримає поточний рік (наприклад, 2026)
prompt = (
    ...
    f"2. Якщо в тексті туру на сайті вказано минулий рік (наприклад, 2024 або 2025), ти повинен проігнорувати цей тур.\n"
    f"3. Будь-які згадки 2024 чи 2025 року повністю заборонені. Кінцевий формат дати має бути виключно цифровим: ДД.ММ.{current_year}.\n\n"
    ...
    f"📅 <b>Виліт/Дата:</b> [Вкажи реальну дату цього туру з тексту у форматі ДД.ММ.{current_year}], [Вкажи кількість ночей саме для цієї ціни]\n"
