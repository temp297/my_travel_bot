...
async def generate_and_send_travel_news():
    ...
    # --- 4. ГЕНЕРАЦІЯ ПРОМПТА З ЖОРСТКИМ ФІЛЬТРОМ ПОВТОРІВ ТА БЕЗ СЛОВА "ФОКУС" ---
    ...
    prompt = (
        ...
        f"Сьогодні {current_date_str}. Напиши свіжий, яскравий, практичний, унікальний та інформативний дайджест світових туристичних новин "
