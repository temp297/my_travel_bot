...
async def generate_and_send_ai_tour_post():
    ...
    for index, cat in enumerate(categories):
        ...
        prompt = (
            ...
            f"3. Якщо в тексті немає взагалі ні 5★, ні 4★ готелів для цієї країни, только в цьому крайньому разі дозволено брати та показувати готелі зірковості 3★ (3*).\n"
            ...
            f"⚠️ ГОЛОВНИЙ КРИТЕРІЙ ВІДБОРУ — ФІЛЬТРАЦІЯ ТА ПРІОРІТЕТ ТРАНСФЕРУ (ДРУГИЙ ЗА ВАЖЛИВІСТЮ):\n"
            f"Після того як ти визначив доступну найвищу зірковість, проаналізуй тип транспорту для цих готелів та відбери варіанти за суворим пріоритетом:\n"
