...
async def generate_and_send_ai_tour_post():
    ...
    for index, cat in enumerate(categories):
        ...
        prompt = (
            ...
            f"📅 <b>Виліт/Дата:</b> [Вкажи дату та кількість ночей, обов'язково використовуючи поточний 2026 рік]\n"
            ...
            f"   - СУВОРЕ ПРАВИЛО ДЛЯ ДАТИ: Записуй дату виключно у цифровому форматі ДД.ММ.2026 (використовуй строго 2026 рік). Ніколи не пиши місяць словами.\n"
